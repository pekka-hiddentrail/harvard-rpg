 ...
 *
 * Turns `packages/user/harvard_course_schema.xlsx` into one course YAML per row under
...
const XLSX = join(root, 'packages', 'user', 'harvard_course_schema.xlsx')
...
const MARKER = '# Generated from packages/user/harvard_course_schema.xlsx by'

const header = (row: Row) => `${MARKER}
# scripts/import-courses.ts. Authored, straight off the sheet: the tags this course asks of
# you, how it meets, and where its office hours are. Absent because it derives: \`demand\`,
